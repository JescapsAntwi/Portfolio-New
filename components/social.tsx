...
const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/JescapsAntwi",
        icon: Icons.github,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/jescapsantwi/",
        icon: Icons.linkedin,
      },
      Medium: {
        name: "Medium",
        url: "https://medium.com/@jescapsantwi",
        icon: Icons.medium,
      },
      X: {
        name: "X",
        url: "https://x.com/KD2pointO",
        icon: Icons.x,
      },
      email: {
        name: "Send Email",
        url: "mailto:antwijescaps1@gmail.com",
        icon: Icons.email,
      },
    },
  },
