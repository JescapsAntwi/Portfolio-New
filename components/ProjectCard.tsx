  ...
  Firebase: {
    ...
    icon: (
      <svg
        ...
        viewBox="0 0 32 32"
      >
        <path fill="#FFCA28" d="M5.8 24.6l.17-7.3L10 19z" />
        <path fill="#FFA000" d="M10 19l4.9-14.3L7.9 24.5z" />
        <path fill="#F57C00" d="M7.9 24.5L5.8 24.6l2.1-12.2z" />
        <path fill="#FFCA28" d="M16 5.3L10 19l12.4 3.3L26 9.3z" />
        <path fill="#FFA000" d="M26 9.3L16 5.3l-2.1 5.2z" />
        <path fill="#FFCA28" d="M16 5.3L10 19l-2.1-12.2z" />
      </svg>
    ),
  },
  // add more icons
