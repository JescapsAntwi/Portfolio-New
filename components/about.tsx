      ...
      <div className="container grid items-center justify-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-12">
        <div className="space-y-4">
          ...
          <p className="max-w-[600px] text-sm text-muted-foreground md:text-base/relaxed lg:text-sm/relaxed xl:text-base/relaxed">
            ...
            high-performing websites that bring ideas to life. With a year of
            hands-on experience, I&apos;ve been diving deep into the world of{" "}
            <span className="font-bold text-red-500 ">
              {" "}
              typescipt, javascript, react, and node.js.
            </span>
        ...
        <div className="grid gap-4">
          <div className="grid gap-1">
            ...
            <p className="text-muted-foreground">
              ...
              Ashesi University. By the way, I&apos;ve worked on some projects
              with small teams and done some free-lancing too. I am always on
              the hunt for the latest tech trends—staying ahead of the curve
              isn&apos;t just a habit, it&apos;s an obsession! - Whether
              it&apos;s a new framework, a cutting-edge tool, or the next big
              thing in web dev, I&apos;m all in!
            </p>
          </div>
          <div className="grid gap-1">
            <h3 className="text-2xl font-bold tracking-tighter md:text-3xl/tight">
            ...
            <p className="text-muted-foreground">
              In the ever-evolving world of web development, my skills define my
              capabilities. I have a strong command of{" "}
              <span className="font-bold text-red-500 ">
                {" "}
                typescipt, javascript, react, and node.js.
              </span>{" "}
              ...
              ensure seamless user experiences across all devices. Additionally,
              my proficiency in Git allows me to maintain clean, structured, and
              well-documented code. I am also fluent in{" "}
              <span className="font-bold text-red-500 ">
                {" "}
